        ...
        // Mock AI responses
        const mockResponses = [
            'Tôi có thể giúp bạn tìm địa điểm phù hợp cho chuyến đi của mình. Bạn muốn đi đâu?',
            'Dựa trên ngân sách của bạn, tôi đề xuất nên lưu trú ở khu vực trung tâm để tiện di chuyển.',
            'Địa điểm này rất phổ biến và có rating cao. Bạn nên đặt chỗ trước để có giá tốt.',
            'Thời gian này là mùa cao điểm, giá có thể cao hơn bình thường khoảng 20-30%.',
            'Tôi có thể giúp bạn tạo một lịch trình chi tiết cho chuyến đi. Bạn muốn bắt đầu không?'
        ];
