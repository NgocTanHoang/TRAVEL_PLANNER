...
# -*- coding: utf-8 -*-
"""
Script để thêm ảnh cho Mai house Saigon hotel
"""
import os
import sys
import django
...
def add_mai_house_image():
    """Thêm ảnh cho Mai house Saigon hotel"""
    
    image_url = "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/28/b7/50/03/overview.jpg?w=1400&h=-1&s=1"
    
    # Tìm Mai house Saigon hotel
    place_names = [
    ...
    if not place:
        print("[ERROR] Không tìm thấy Mai house Saigon hotel trong database!")
        ...
        if hcm:
            hotels = DiaDiem.objects.filter(
                ...
                tenDiaDiem__icontains="Mai"
            )
            print(f"[INFO] Tìm thấy {hotels.count()} khách sạn có chứa 'Mai':")
            for hotel in hotels:
        ...
        with connection.cursor() as cursor:
            ...
            try:
                new_image = HinhAnhDiaDiem(
                    ...
                    moTa="Hình ảnh tổng quan Mai house Saigon hotel"
                )
                new_image.save()
...
if __name__ == '__main__':
    print("="*60)
    print("Thêm ảnh cho Mai house Saigon hotel")
    print("="*60)
    add_mai_house_image()
    print("="*60)
